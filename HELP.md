...
Levelupgamer Spring Boot project (generated)

Run:

- Update src/main/resources/application.properties with Oracle credentials.
- mvn spring-boot:run
...
- GET /cart/{username}
- POST /cart/add?username=...&productId=...&quantity=...
- DELETE /cart/{id}
